...
export default async function (request, response)
{
    try
    {
        ...
        if((typeof token == "undefined") || (typeof schedule_id == "undefined") || (typeof title == "undefined")) //TODO try request.body.hasOwnProperty('token');
        {
        ...
        {
            return response.status(400).json({errors: [{msg: "New title is required"}] });
        }
